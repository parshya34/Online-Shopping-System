...
int main() {
    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 4:
                if (cartSize > 0) {
                    printf("Order placed successfully! Total Cost: $%.2lf\n", totalCost);
                    cartSize = 0;
                    totalCost = 0;
                } else {
                    printf("Your cart is empty. Please add items to your cart before placing an order.\n");
                }
                break;
            case 5:
                printf("Thank you for using our Online Shopping System. Goodbye!\n");
                exit(0);
            default:
